      ...
      <div class="about-serv__bg-img">
        <div class="about-serv__text-reg">
          <p class="about-serv__text-reg-body">
            Мы помогаем нашим пользователям работать и тренироваться не выходя
            из дома. Записывайте видео, делитесь достижениями в социальных сетях
            и поддерживайте свое здоровье вместе с нами!
          </p>
        </div>
      </div>
    </div>
