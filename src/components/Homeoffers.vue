<template>
  <section class="offers-block-bg block-grid">
    <div class="offers-block">
      <div class="offer">
        ...
        <p class="offer__body text__heading_size_m">
          ...
          <br />в группах, наш сервис <br />предостави вам возможность <br />не
      ...
      <div class="offer">
        ...
        />
        <p class="offer__body text__heading_size_m">
          Мы заботимся о комфорте наших
          <br />клиентов. Если вы чувствуете себя <br />увереннее на
          индивидуальных <br />занятия, наш сервис поможет вам
          <br />
        </p>
      </div>
      <div class="offer">
        ...
        <p class="offer__body text__heading_size_m">
          ...
          <br />когда вам удобно и есть желание. <br />Выбирайте тренера и
          начинайте <br />достигать своих целей
          <br />
        </p>
      </div>
    </div>
